...
import type {} from '../ParameterBuilder/types.js'
...
> {
  ...
  parameter<$Builder extends BuilderCommandState.ParameterBuilderMinimumState>(
    this: void,
    builder: $Builder,
  ...
  >(
    ...
    BuilderCommandState.AddParameter<$State, NameExpression, Configuration>
  >
  parameter<NameExpression extends string, $Type extends $State['Type']>(
    ...
    BuilderCommandState.AddParameter<$State, NameExpression, { type: $Type }>
  >
  parametersExclusive<
    Label extends string,
    $BuilderExclusive extends BuilderExclusive<$State>,
  >(
    this: void,
    label: Label,
    ...
    $BuilderExclusive[ExclusiveBuilderStateSymbol]['commandBuilderState']
  >
