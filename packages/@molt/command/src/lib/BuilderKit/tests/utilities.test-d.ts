...
type S1 = { data: { a: VA1 }; resolve: null }
type S4 = { data: { a: V4 }; resolve: null }
type S5 = { data: { a: V5 }; resolve: null }
type S6 = { data: { a: V6 }; resolve: null }
type S7 = { data: { a: V7 }; resolve: null }
type SA = { data: { a: VA1 }; resolve: null }
type SB = { data: { a: V1Set }; resolve: null }
...
test('State.Property.Value.*', () => {
  ...
  expectTypeOf<BuilderKit.State.Property.Value.GetOrDefault<{data:{a:BuilderKit.State.Values.Atom<1|2>};resolve:null}, 'a'>>().toEqualTypeOf<1|2|BuilderKit.State.Values.Unset>()
  expectTypeOf<BuilderKit.State.Property.Value.GetOrDefault<{data:{a:BuilderKit.State.Values.Atom<1|2,1>};resolve:null}, 'a'>>().toEqualTypeOf<1>()
  ...
  expectTypeOf<BuilderKit.State.Property.Value.GetSet<{data:{ a: V1Set };resolve:null}, 'a'>>().toEqualTypeOf<2>()
  // @ts-expect-error test
  expectTypeOf<BuilderKit.State.Property.Value.GetSet<{ a: V1Set }, 'a'>>().toEqualTypeOf<2 | BuilderKit.State.Values.Unset>()
  //---
  expectTypeOf<BuilderKit.State.Property.Value.IsSet<{data:{ a: V1Set };resolve:null}, 'a'>>().toEqualTypeOf<true>()
  expectTypeOf<BuilderKit.State.Property.Value.IsSet<S1, 'a'>>().toEqualTypeOf<false>()
  //---
  expectTypeOf<BuilderKit.State.Property.Value.IsUnset<{data:{ a: V1Set };resolve:null}, 'a'>>().toEqualTypeOf<false>()
  expectTypeOf<BuilderKit.State.Property.Value.IsUnset<S1, 'a'>>().toEqualTypeOf<true>()
  //---
  expectTypeOf<BuilderKit.State.Property.Value.Set<S1, 'a', 2>>().toMatchTypeOf<{data:{ a: V1Set };resolve:null}>()
  ...
  //---
  expectTypeOf<BuilderKit.State.Property.Value.SetAll<S1, { a: 2 }>>().toMatchTypeOf<{data:{ a: V1Set };resolve:null}>()
  expectTypeOf<BuilderKit.State.Property.Value.SetAll<{data:{ a: VA1, b: V1Set, c: VA1 };resolve:null}, { a: 2 }>>().toMatchTypeOf<{data:{ a: V1Set /* < */, b: V1Set, c: VA1 };resolve:null}>()
  ...
  //---
  expectTypeOf<BuilderKit.State.Setup<S1, { x: 0 }>>().toEqualTypeOf<BuilderKit.SetupHost<{data:{a:VA1};resolve:null},{x:0}>>()
  //---
...
// prettier-ignore
test('State.Initial', () => {
  expectTypeOf<BuilderKit.State.RuntimeData<{data:{ a: V3 };resolve:null}>>().toEqualTypeOf<{ readonly a: 2 }>()
  ...
  expectTypeOf<BuilderKit.State.RuntimeData<{data:{ a: V1Set };resolve:null}>>().toEqualTypeOf<{ readonly a: 2 }>()
  // @ts-expect-error test
