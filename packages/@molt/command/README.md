...
- [Features](#features)
  ...
  - [🧩 Extensible](#%F0%9F%A7%A9-extensible)
...
- [Docs](#docs)
  ...
  - [Parameter Naming](#parameter-naming)
    ...
    - [Internal Canonical Form](#internal-canonical-form)
...
| Zod                                                                               | Molt Type             |
| --------------------------------------------------------------------------------- | --------------------- |
| [`boolean`](https://github.com/colinhacks/zod#booleans)                           | [`boolean`](#boolean) |
| [`string`](https://github.com/colinhacks/zod#strings)                             | [`string`](#string)   |
| [`number`](https://github.com/colinhacks/zod#numbers)                             | [`number`](#number)   |
| [`enum`](https://github.com/colinhacks/zod#zod-enums)                             | [`enum`](#enum)       |
| [`nativeEnum`](https://github.com/colinhacks/zod#native-enums)                    | [`enum`](#enum)       |
| [`union`](https://github.com/colinhacks/zod#unions) (of any other Zod type above) | [`union`](#union)     |
